...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td>{fieldLabel name="authors-$authorIndex-orcid" key="user.orcid"}</td>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%">{fieldLabel name="copyrightHolder" key="submission.copyrightHolder"}</td>
	...
	<tr valign="top">
		<td>{fieldLabel name="copyrightYear" key="submission.copyrightYear"}</td>
