...
<table class="form">
<tr valign="top">
	<td width="20%" class="label">AAAAA{translate key="locale.primary"}</td>
...
<p><input type="submit" value="{translate key="admin.languages.installLocales"}" class="btn btn-primary" /> <input type="button" value="{translate key="common.cancel"}" class="btn btn-default" onclick="document.location.href='{url page="admin" escape=false}'" /></p>
{/if}
</div>
</form>
