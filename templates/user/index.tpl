	...
	<table width="100%" class="table table-striped	">
		...
		{if $isValid.Editor.$journalId}
			<tr>
				...
				<td class="text-center">{if $editorSubmissionsCount[0]}
						<a href="{url journal=$journalPath page="editor" op="submissions" path="submissionsUnassigned"}">{$editorSubmissionsCount[0]}<br>{translate key="common.queue.short.submissionsUnassigned"}</a>
					{else}<span class="disabled">0<br>{translate key="common.queue.short.submissionsUnassigned"}</span>{/if}
				</td>
				<td class="text-center">{if $editorSubmissionsCount[1]}
						<a href="{url journal=$journalPath page="editor" op="submissions" path="submissionsInReview"}">{$editorSubmissionsCount[1]}<br>{translate key="common.queue.short.submissionsInReview"}</a>
					{else}<span class="disabled">0<br>{translate key="common.queue.short.submissionsInReview"}</span>{/if}
				</td>
				<td class="text-center">{if $editorSubmissionsCount[2]}
		...
		{if $isValid.SectionEditor.$journalId}
			...
			<tr>
				...
				<td></td>
				<td class="text-center">{if $sectionEditorSubmissionsCount[0]}
						<a href="{url journal=$journalPath page="sectionEditor" op="index" path="submissionsInReview"}">{$sectionEditorSubmissionsCount[0]}<br>{translate key="common.queue.short.submissionsInReview"}</a>
					{else}<span class="disabled">0<br>{translate key="common.queue.short.submissionsInReview"}</span>{/if}
				</td>
				<td class="text-center">{if $sectionEditorSubmissionsCount[1]}
		...
		{if $isValid.LayoutEditor.$journalId}
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="text-center">{if $layoutEditorSubmissionsCount[0]}
		...
		{if $isValid.Copyeditor.$journalId}
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="text-center">{if $copyeditorSubmissionsCount[0]}
		...
		{if $isValid.Proofreader.$journalId}
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="text-center">{if $proofreaderSubmissionsCount[0]}
		...
		{if $isValid.Author.$journalId}
			...
			<tr>
				...
				<td></td>
				<td class="text-center">{if $authorSubmissionsCount[0]}
						<a href="{url journal=$journalPath page="author"}">{$authorSubmissionsCount[0]}<br>{translate key="common.queue.short.active"}</a>
					{else}<span class="disabled">0<br>{translate key="common.queue.short.active"}</span>{/if}
				</td>
				{* This is for all non-pending items*}
				<td class="text-center">{if $authorSubmissionsCount[1]}
		...
		{if $isValid.Reviewer.$journalId}
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="text-center">{if $reviewerSubmissionsCount[0]}
