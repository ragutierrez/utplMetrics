...
{if count($editors) > 0}
	<div id="editors" class="panel panel-default">
	{if count($editors) == 1}
...
{if count($sectionEditors) > 0}
	<div id="sectionEditors" class="panel panel-default">
...
{if count($layoutEditors) > 0}
	<div id="layoutEditors" class="panel panel-default">
...
{if count($copyEditors) > 0}
	<div id="copyEditors" class="panel panel-default">
...
{if count($proofreaders) > 0}
	<div id="proofreaders" class="panel panel-default">
