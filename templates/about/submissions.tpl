...
<div id="onlineSubmissions" class="panel panel-default"><h3>{translate key="about.onlineSubmissions"}</h3>
<p>
...
<div id="authorGuidelines" class="panel panel-default"><h3>{translate key="about.authorGuidelines"}</h3>
...
{if $submissionChecklist}
	<div id="submissionPreparationChecklist" class="panel panel-default"><h3>{translate key="about.submissionPreparationChecklist"}</h3>
...
<div id="copyrightNotice" class="panel panel-default"><h3>{translate key="about.copyrightNotice"}</h3>
<p>{$currentJournal->getLocalizedSetting('copyrightNotice')|nl2br}</p>

</div>
{/if}

{if $currentJournal->getLocalizedSetting('privacyStatement') != ''}<div id="privacyStatement" class="panel panel-default"><h3>{translate key="about.privacyStatement"}</h3>
